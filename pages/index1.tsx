...
<div className="grid grid-cols-2 divide-x ">
    ...
    <div className='text-xl font-semibold mb-20 mt-4'>
      <br/>
      <input className='text-xl font-bold mb-2 mt-1' type="text" placeholder="Enter Patient's Eth Address" value={id} onChange={(e) => setId(e.target.value)} />
      <br/> 
     ...
     <div className='text-xl font-semibold mb-20 mt-4'>
      <br/>
      <input className='text-xl font-bold mb-2 mt-1' type="text" placeholder="View Health Records" value={id} onChange={(e) => setId(e.target.value)} />
      <br/> 
     <button className='text-xl font-bold py-3 px-12 bg-[#ffd75f] rounded-lg mb-10 hover:scale-105 transition duration-500 ease-in-out'
     onClick={getRecords} >
